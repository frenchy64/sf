...
Lemma duality_ind : forall b:bool, b = true \/ b = false.
induction b.
left.
reflexivity.
right.
...
Eval compute in negb true = true.
...
(**
Lemma nandb_eq_orb_t_t :
  andb false false <> orb false false.
Proof.
  reflexivity.
Qed.

Lemma andb_eq_orb_f_f :
  andb true true = orb true true.
Proof.
  reflexivity.
Qed.
